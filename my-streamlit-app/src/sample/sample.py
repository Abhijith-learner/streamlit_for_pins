...
df = pd.read_excel("Demo-Hygine Data V3.xlsx")
...
def show_analytics():
    ...
    mode = st.sidebar.radio("View mode:", ["Summary", "Drill Down"]) #, "Sales vs Target Trend"
    ...
    if mode == "Summary":
        ...
        show_sales_vs_target_tab(df_sales)
    else:
...
def show_sales_vs_target_tab(df):
